...
def generate_app_html(slides, out_path=None):
    ...
    full_html = (
        ...
        'TikTok風の縦スワイプUIで、ニュースやSNSの流行をすばやくチェックできます。">'
        '<meta property="og:type" content="website"><meta property="og:url" content="https://vibra-reboot.github.io/"><meta property="og:image" content="https://vibra-reboot.github.io/ogp-default.png?v={version}"><meta property="og:image:width" content="1200"><meta property="og:image:height" content="630"><meta name="twitter:card" content="summary_large_image">'
        + FAVICON_SVG +
